...
figure(8)
fun2 = @(x1,x2) (beta(1,1)*0.5 + beta(2,1)*0.5 + beta(3,1)*0.5 + beta(4,1)*x1 + beta(5,1)*0.5 + beta(6,1)*0.5 + beta(7,1)*x2);
fsurf(fun2, [0 1])
...
figure(9)
fun2 = @(x1,x2) (beta(1,1)*0.5 + beta(2,1)*x2 + beta(3,1)*0.5 + beta(4,1)*x1 + beta(5,1)*0.5 + beta(6,1)*0.5 + beta(7,1)*0.5);
fsurf(fun2, [0 1])
title('Regression equation of Maximum Velocity 3')
xlabel('Normalised Total Time Over Drop')
ylabel('Normalised Drop Distance')
zlabel('Normalised Maximum Velocity')

figure(10)
fun2 = @(x1,x2) (beta(1,1)*0.5 + beta(2,1)*0.5 + beta(3,1)*0.5 + beta(4,1)*x1 + beta(5,1)*x2 + beta(6,1)*0.5 + beta(7,1)*0.5);
fsurf(fun2, [0 1])
title('Regression equation of Maximum Velocity 4')
xlabel('Normalised Total Time Over Drop')
